...
object Server {
    fun getFilms(): List<FilmData> = listOf(
        ...
        FilmData(9, "https://b1.filmpro.ru/c/10103.jpg",
            "8.3", "Американская история X", false),
